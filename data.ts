...
export const series = [
  ...
  function promSerie (serieP: Serie[]): number{
  ...
  function showpromSerie (serieP: Serie[]): void{
    let promedio: number = promSerie(serieP);
    let x : HTMLElement = document.createElement("tr");
